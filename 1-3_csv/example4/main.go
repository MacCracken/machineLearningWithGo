...
// CSVRecord contains a succesffully parsed row of the CSV file
...
func main() {
	...
	// line will help us keep track of the line number for logging
	line := 1
	...
	for {
		...
		// Parse each of the values in the records based on an expected type.
